...
- [Mini Tools Image Resizer & Compressor](https://mini-tools.uk/image) — browser-based image compressor, resizer and WebP converter. ![free.svg](https://github.com/LisaDziuba/Awesome-Design-Tools/blob/master/Media/free.svg)
